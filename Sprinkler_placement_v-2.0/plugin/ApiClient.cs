...
namespace SprinklerPlugin
{
    ...
    {
        // v2 backend runs on :9002 (v1 on :9001). Both /api/zwcad/scenarios
        // and the new /api/zwcad/auto live on the v2 server.
        public const string BaseUrl = "http://localhost:9002";
